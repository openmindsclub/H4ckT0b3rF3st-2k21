...
Label(root, text = 'Enter the link:', font=  'Modern',bg="tomato").place(x= 180 , y = 60)
...
Button(root,text = 'DOWNLOAD', font = 'arial 15 bold' ,bg = 'white', padx = 2, command = Download,activebackground='light green').place(x=180 ,y = 150)
